...
class TestSocket(unittest.TestCase):
    ...
    def test_read_write_opts(self):
        ...
        s.set_opts(optflag=0, frame_txtime=0x55, ext_address=0x11, txpad=0x22, rxpad=0x33, rx_ext_address=0x44, tx_stmin=0x55)
        o = s.get_opts()
    ...
    def test_receive_transmit_fc_opts(self):
        ...
        self.assertLess(diff, expected_time * 1.5)  # 
