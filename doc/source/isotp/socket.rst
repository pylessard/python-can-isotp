...
.. py:method:: socket.set_fc_opts(bs=None, stmin=None, wftmax=None)
   ...
   :param stmin: The minimum separation time sent in the flow control message. Indicates the amount of time to wait between 2 consecutive frame. This value will be sent as is over CAN. Values from 0 to 127 means milliseconds. Values from 0xF1 to 0xF9 means 100us to 900us
   :type stmin: int
