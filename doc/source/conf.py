...
latex_documents = [
    (master_doc, 'isotp.tex', u'isotp Documentation',
...
man_pages = [
    (master_doc, 'isotp', u'isotp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'isotp', u'isotp Documentation',
     author, 'isotp', 'Python package that provides support for IsoTP protocol (ISO-15765).',
     'Miscellaneous'),
]
